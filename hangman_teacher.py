...
class Hangman():
	...
	def core_game(self):
		...
		while guesses <= 6:
			...
			if len(guess) > 1:
				if guess == the_word:
					print " "
					print "Congrats you've won!" # ********* PROBLEM #3 :: Is this in the right place? ***
					print "Come back soon!"
					print " "
					quit()
				else:
					print " "
					print "You've tried to guess the whole word!" # ********* PROBLEM #3 :: Is this in the right place? ***
				...
				if guess in the_word:
					...
					if guess not in letters_used:
						guesses = guesses + 1 #  *************************** PROBLEM #2 :: Why is it not changing?  ***
	...
	def hangman_graphic(self, guesses):
		if guesses == 0:
			...
			print "|      |      "
			print "|      0      "
			print "|     /|      " # *************** PROBLEM #1 :: something is missing here... ***
			print "|             "
			print "|             "
		elif guesses == 4:
			print "________      "
